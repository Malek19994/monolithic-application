...
describe('Region e2e test', () => {
  ...
  it('should load Regions', async () => {
    ...
    expect(await regionComponentsPage.getTitle()).to.eq('blogApp.region.home.title');
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle()).to.eq('blogApp.region.home.createOrEditLabel');
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle()).to.eq('blogApp.region.delete.question');
