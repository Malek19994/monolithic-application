...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('blogApp.jobHistory.home.title');
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('blogApp.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('blogApp.jobHistory.delete.question');
