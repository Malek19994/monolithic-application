...
describe('Location e2e test', () => {
  ...
  it('should load Locations', async () => {
    ...
    expect(await locationComponentsPage.getTitle()).to.eq('blogApp.location.home.title');
  ...
  it('should load create Location page', async () => {
    ...
    expect(await locationUpdatePage.getPageTitle()).to.eq('blogApp.location.home.createOrEditLabel');
  ...
  it('should delete last Location', async () => {
    ...
    expect(await locationDeleteDialog.getDialogTitle()).to.eq('blogApp.location.delete.question');
